...
INSERT INTO member (id, prename, lastname, password, username, authority, last_pass_change) VALUES
  (1, 'Albert', 'Einstein', '$2a$10$fdivNJC5meS7mOM.QVKqZeVDHtn46arLIIgik6xbUg2w3eACiazCC', 'albert.einstein', 'admin', '20220408'),
  (2, 'Mac',  'Afee', '$2a$10$Bf6.b0FT30EibG1s.BZmL.14vSyWrQzFNI6q4UXkNmvmkUd3trcfO', 'mac.afee', 'member', '20220208'),
  (3, 'Tony',  'Stark', '$2a$10$Y5WfhqTlN91E0j88FXVOduxHiwCnSSfgGCrcivzPhzhM889f02.u6', 'tony.stark', 'supervisor', '20220401'),
